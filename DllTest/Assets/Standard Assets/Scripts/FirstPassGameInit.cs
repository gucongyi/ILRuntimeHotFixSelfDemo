...
public class FirstPassGameInit : MonoBehaviour
{
...
#else
        WWW www = new WWW("file:///" + Application.streamingAssetsPath + "/Assembly-CSharpReplace.dll");
#endif
        while (!www.isDone)
            yield return null;
    ...
    void OnHotFixLoaded()
    {
        //appdomain.Invoke("GameInit", "Init", null, null);
        appdomain.Invoke("gcy.TestMonoBehaviour", "RunTest2", null, gameObject);
        //var type = appdomain.LoadedTypes["gcy.GameInit"] as ILType;
        //var smb = GetComponent(type);
        //var m = type.GetMethod("Awake");
